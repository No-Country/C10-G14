## REST API World Fit | Backend

This is the backend part of the WorldFit project, it is a REST API secured with Oauth2.0 where the main functionalities of the project will run.

### PROJECT SETUP & TOOLS
1. JDK 20
2. [Postgre](https://www.postgresql.org/download/).
